# Microcontroller Setup: All Microcontrollers (Mac)

This guide will walk you through setting up your microcontroller on Mac. This is mainly provided as supplemental information as you will need to follow the Windows setup, but with the appropriate modifications for Mac.

## Step 1: Acquire the hardware.

See the corresponding Windows guides for the required hardware for your device. The hardware is the same on Windows and Mac.
